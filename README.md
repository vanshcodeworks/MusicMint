...
`d3829f1` — Enhanced glassmorphism contrast (UI contrast adjustments to cards and overlays).
`ae7d214` — Added frontend caching/sorting for listings (client-side caching and improved sort controls).
